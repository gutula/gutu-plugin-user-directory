...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/user-directory");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-user-directory:");
...
console.log("Documentation check passed for gutu-plugin-user-directory.");
